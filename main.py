...
if not st.session_state.form_submitted:
    with st.form("my_form"):
        ...
        resume_file = st.file_uploader(label="Upload your Resume/CV in only PDF format", type="pdf")
...
if st.session_state.form_submitted:
    ...
    # Displaying Report 
    st.markdown(f"""
            <div style='text-align: left; background-color: black; padding: 10px; border-radius: 10px; margin: 5px 0;'>
                {report}
            </div>
